...
namespace POSV1.TenantAPI.Controllers.Accounting
{
            ...
            string>
    {
        ...
        public IncomeVoucherController(
        ...
        private static IQueryable<VMVoucherList> GetData(IQueryable<vou02voucher_summary> filteredData)
        {
            ...
            {
                throw new Exception("Income vouchers not found");
            }


            var value = filteredData.Select(voucher => new VMVoucherList
            {
            ...
            //var temp = JsonSerializer.Serialize(value.ToList()[4]);
            return value;
        }
        ...
        {
            var filteredData = data
                   .Where(x => x.vou01voucher_types.vou01title == "Income" && x.vou02status == EnumVoucherStatus.Approved);
            return GetData(filteredData);
        }
        ...
        {
            var filteredData = data
                   .Where(x => x.vou01voucher_types.vou01title == "Income" && x.vou02status == EnumVoucherStatus.Pending);
            return GetData(filteredData);
        }
        ...
        protected override VMVoucherListDetail ProcessDetailData(vou02voucher_summary data)
        {
            try
            {
                ...
                var contraLedgerDetail = _ledgersRepo.GetDetail((int)data.vou02contra_led05uin);
        ...
        protected override vou02voucher_summary AssignValues(VMVoucher Data)
        {
            ...
            var voucherEntity = new vou02voucher_summary
            {
                ...
                vou02vou01uin = (int)EnumVoucherTypes.Income,
