...
namespace POSV1.TenantAPI.Controllers.Accounting
{
            ...
            string>
    {
        ...
        {
            var filteredData = data
                   .Where(x => x.vou01voucher_types.vou01title == "Expense" && x.vou02status == EnumVoucherStatus.Approved);
            return GetData(filteredData);
        }
        protected override IQueryable<VMVoucherList> ProcessUnApprovedListData(IQueryable<vou02voucher_summary> data)
        {
            var filteredData = data
                   .Where(x => x.vou01voucher_types.vou01title == "Expense" && x.vou02status == EnumVoucherStatus.Pending);
            return GetData(filteredData);
        }
        ...
        protected override VMVoucherListDetail ProcessDetailData(vou02voucher_summary data)
        {
            if (data == null)
            {
                throw new Exception("Expense vouchers not found");
            }
        ...
        protected override vou02voucher_summary AssignValues(VMVoucher Data)
        {
            ...
            var voucherEntity = new vou02voucher_summary
            {
                ...
                vou02vou01uin = (int)EnumVoucherTypes.Expense,
